...
class ShareIdea extends React.Component {
  render() {
    return (
      <React.Fragment>
        <form method="POST" className="shareIdea--container">
          ...
          />
          <Button type="button" onClick={this.props.handleButtonClick} variant="success" style={{backgroundColor:`#7db238`}} className="shareIdea--button">Add your comment</Button>
        </form>
      </React.Fragment>
    );
  }
